...
class RNNModel(nn.Module):
    def __init__(self,BATCH_SIZE, HIDDEN_SIZE, OUTPUT_SIZE, NUM_LAYERS=1):
        super().__init__()
...
def train(model, LEARNING_RATE, EPOCHS, trainset):
...
if __name__ == '__main__':
    ...
    DATAPATH = 'C:\\Users\\WU\\Desktop\\NUS\\IOT\\Project\\samples.npy'
    LABELPATH = 'C:\\Users\\WU\\Desktop\\NUS\\IOT\\Project\\labels.npy'
    ...
    train(model, LEARNING_RATE, EPOCHS, trainset)
    #test(model,testset)
    
    SPECIALTESTPATH = 'C:\\Users\\WU\\Desktop\\NUS\\IOT\\Project\\test_samples(3).npy'
    SPECIALLABELPATH = 'C:\\Users\\WU\\Desktop\\NUS\\IOT\\Project\\test_labels(4).npy'
